...
test_that("The separate_variances option works for two-level models.", {
  # lme
  AR1_lme_no_sep <- extract_varcomp(Laski_AR1_lme, separate_variances = FALSE)
  AR1_lme_sep <- suppressWarnings(extract_varcomp(Laski_AR1_lme, separate_variances = TRUE))
  expect_equal(AR1_lme_no_sep, AR1_lme_sep)
  expect_warning(extract_varcomp(Laski_AR1_lme, separate_variances = TRUE))
  ...
  AR1_gls_sep <- suppressWarnings(extract_varcomp(Laski_AR1_gls, separate_variances = TRUE))
  expect_equal(AR1_gls_no_sep, AR1_gls_sep)
  expect_warning(extract_varcomp(Laski_AR1_gls, separate_variances = TRUE))
