...
#' \emph{Journal of Applied Behavior Analysis, 34}(4), 425-446.
#'
...
#' school-age children with pervasive developmental disorder.
#' \emph{Journal of Speech Language and Hearing Research, 47}(1), 126-144.
#'
...
#' \emph{Archives of Psychology, 2}(11), 1-24.
#'
